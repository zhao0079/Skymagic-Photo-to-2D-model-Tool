...
if img_file_buffer is not None:
    ...
    gray = cv2.cvtColor(image_sharp1, cv2.COLOR_BGR2GRAY)
    ...
    for dot in dots:
        color_x = (dot[0])
        color_y = (dot[1])
        text_contents = text_contents + f'{dot[0]},{dot[1]},{img[color_y, color_x, 2]},{img[color_y, color_x, 1]},{img[color_y, color_x, 0]}\n '
